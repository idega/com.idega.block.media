...
//    return mediaProps;
  ...
  public static boolean deleteMedia( int mediaId ) {
    ...
    try {
      ...
      ((com.idega.core.data.ICFileHome)com.idega.data.IDOLookup.getHomeLegacy(ICFile.class)).findByPrimaryKeyLegacy( mediaId ).delete();
...
//    return file;
  ...
  public static boolean moveMedia(int mediaId, int newParentId){
    ...
    try {
      ...
      ICFile media = ((com.idega.core.data.ICFileHome)com.idega.data.IDOLookup.getHomeLegacy(ICFile.class)).findByPrimaryKeyLegacy(mediaId);

      ICFile newParent = ((com.idega.core.data.ICFileHome)com.idega.data.IDOLookup.getHomeLegacy(ICFile.class)).findByPrimaryKeyLegacy(newParentId);
